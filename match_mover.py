...
def render(img, obj, projection, h, w, color=False, scale=1):
    ...
    t = projection[:, 2]
    projection_norm_l2 = np.linalg.norm(t)
    global a12a13_vector, t_0
    #print("t", t)
    #print("t_0", t_0)

    if projection_norm_l2 > a12a13_vector or projection_norm_l2 > norm_l2_avg:
        projection[0,3] = t_0[0]
        projection[1,3] = t_0[1]

    #print("proj", projection_norm_l2)
    #print("a12a13_vector", a12a13_vector)
    #print("norm_l2_avg", norm_l2_avg)
    ...
    a12a13_vector = projection_norm_l2
    t_0 = t
...
if __name__ == '__main__':
    ...
    poses, has_pose, names = read_kerframe_trajectory(f'./orbslam_driver/extracted/{scene_name}/KeyFrameTrajectory.txt',
                                                      f'./orbslam_driver/extracted/{scene_name}/rgb.txt')
    ...
    for i in range(5):
        ...
        t_model = np.array([[0, 0, -1]]).T  # 14000
        ...
        T = P[ :,2]
        norm_l2 += np.linalg.norm(T)
    #elso 5 mozgast leiro vektor 2. norma atlaga
    norm_l2_avg = norm_l2 / 5
    a12a13_vector = norm_l2 / 5
    t_0 = T
    #print(norm_l2_avg)
